...
\begin{problem}{}{1}
Convert the Hamiltonian $\hamiltonian$ into spherical coordinates.  Then convert into \boldblue{atomic units} so that $\frac{\hbar^2}{m_p}=1$ and $\frac{e^2}{4\pi \epsilon_0}=1$.  Finally, write down the full Schr\"odinger equation for the hydrogen atom in spherical coordinates with atomic units.
\end{problem}
