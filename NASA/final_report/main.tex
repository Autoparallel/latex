...
\colin{I need to fix some of the citations and add in the tangent bundle stuff. Drop superfluous subscripts when we start working with EM stuff as it would look way better. Probably change title}
\begin{abstract}
