...
\resumeItemListStart
            ...
            \resumeItem{\normalsize{Writing multiple papers on the use of Clifford algebras in topology and the role of topological measurements in electromagnetism to continue the geometric approach to the Vlasov equation.}}
	\resumeItemListEnd
\vspace*{-5pt}
\resumeProjectHeading{\bf{Ongoing collaboration in Data Assimilation}}{~}
\resumeItemListStart
\resumeItem{\normalsize{Developing proprietary code base for ocean-atmosphere analyses to explore the coupling between the sea and atmosphere. \href{https://github.com/ColinPR/projected_particle_filter.git}{\accentcolor{[Github]}}}}
\resumeItem{\normalsize{Optimizing algorithm performance while adding capability to probe for non-Gaussian behavior.}}
	\resumeItemListEnd
\vspace*{-5pt}
