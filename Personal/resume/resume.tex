...
\resumeSubHeadingListStart
          ...
          {\href{}{\textbf{\large{Graduate Student}}} $|$ \large{Collbarotation, Research, and Teaching}}{08/2017 -- Present}
        %\vspace*{-1cm}
        \resumeProjectHeading{Colorado State University, Fort Collins, CO}{~}
          \resumeItemListStart
            ...
            \resumeItem{Author of \normalsize{\emph{A Gelfand Transform for Spinor Fields on Embedded Riemannian Manifolds.} \href{https://https://arxiv.org/abs/2203.00118}{\accentcolor{[Preprint]}}}}
	\resumeItemListEnd
\vspace*{-5pt}
\resumeProjectHeading{\bf{Ongoing collaboration with NASA}}{~}
\resumeItemListStart
\resumeItem{\normalsize{Networking with experts in the field of topological electromagnetism.}}
            \resumeItem{\normalsize{Writing a paper describing the practical reasons for using of Clifford algebras in (co)homology which include providing new proofs and new results.}}
			\resumeItem{\normalsize{Writing a paper describing the topological properties of electrical components and measurement devices.}}
	\resumeItemListEnd
\vspace*{-5pt}
\resumeProjectHeading{\bf{Ongoing collaboration in Data Assimilation}}{~}
\resumeItemListStart
\resumeItem{\normalsize{Furthering development of our code base and apply our code to ocean-atmosphere models to analyze our algorithm's performance, probe non-Gaussian behavior, and explore the coupling in the sea-surface. \href{https://github.com/ColinPR/projected_particle_filter.git}{\accentcolor{[Github]}}}}
	\resumeItemListEnd
\vspace*{-15pt}
...
\section{Hobbies}
	...
	Outside of my professional experience, I am an avid hiker and mountain biker. I also aspire to be a better chef, baker, and equity trader.
