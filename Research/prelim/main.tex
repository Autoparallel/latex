...
\usepackage{xfrac}
\usepackage{color, soul} % Colored text and highlighting, respectively
...
\title{Geometric Calculus and a Noncommutative Gelfand Representation}
...
\vfill
\begin{itemize}
    \item \boldgreen{Geometric algebra} originated in 1878 with William Kingdon Clifford's work that extends Hermann Grassmann's \boldgreen{exterior algebra}.
    \pause
    \item \boldgreen{Geometric calculus} arrived in 1984 due to David Hestenes and Garrett Sobczyk in order to enrich \'Ellie Cartan's \boldgreen{differential forms}.
\end{itemize}
\vfill
\end{frame}
...
\vfill
    ...
    \pause
    \begin{itemize}
        \item Take the tensor algebra
        \[
        \mathcal{T}(T_pM) \coloneqq \bigoplus_{j=0}^\infty T_pM^{\otimes_j} = \R \oplus (T_pM \otimes T_pM) \oplus (T_pM \otimes T_pM \otimes T_pM) \oplus \cdots.
        \]
    
        \item Form the quotient algebra
        \[
        \G = \mathcal{T}(T_pM)/ \langle \blade{v}
        \]
