...
\todo[inline]{introduce the $\Omega^k(M)$ notation here at some point}

\subsection{Riemannian manifolds}

\todo[inline]{Define the exterior derivative and codifferential here as well?}
...
\todo[inline]{Add $B$-planar fields and show they are equivalent to $\omega$-axial but also generalize the idea. This should allow this paper to be generalized to the $n$-ball.}
